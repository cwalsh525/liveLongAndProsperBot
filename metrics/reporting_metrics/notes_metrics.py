...
class NotesMetrics:
    ...
    def get_notes_by_rating_data(self):
        ...
        #                                 select note_status_description, principal_balance_pro_rata_share, principal_paid_pro_rata_share, interest_paid_pro_rata_share, age_in_months, payment_received, note_ownership_amount, ownership_start_date, prosper_rating, note_ownership_amount, lender_yield, days_past_due }
